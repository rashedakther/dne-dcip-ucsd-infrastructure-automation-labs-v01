# Cisco DevNet Learning Labs: DevNet Express Data Center Infrastructure Programmability DNE DCIP UCSD Infrastructure

These self-paced interactive tutorials provide instructions for developers to manage hardware with Cisco UCSD.
...
* Learn UCSD.
* Create UCSD custom tasks.
* Learn the REST API browser in UCSD.
* Use UCSD to execute a workflow and monitor it with APIs.
